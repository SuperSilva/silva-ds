...
const SelectTriggerBase = styled.button`
  display: flex;
  align-items: center;
...
export const DefaultSelectTrigger = styled(SelectTriggerBase)`
...
export const OutlineSelectTrigger = styled(SelectTriggerBase)`
...
export const SelectPanelRoot = styled.div`
  background-color: #ffffff;
  border: 1px solid ${tokens.color.border};
  border-radius: ${tokens.radius.md};
...
export const SelectOptionRoot = styled.div`
  display: flex;
  align-items: center;
  cursor: pointer;
...
export const selectOptionSizes = {
  sm: css`
